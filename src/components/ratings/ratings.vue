        ...
        <div class="overview-left">
          ...
          <div class="other-score">
            <div class="quality-score item">
              ...
              <Star :score="ratings.quality_score"
                    class="star"></Star>
      ...
      <div class="content">
        ...
        <div class="rating-select"
          ...
          <span class="item"
            ...
            <img v-show="selectType!=0"
                 src="./img/icon_sub_tab_dp_normal@2x.png" />
            <img v-show="selectType==0"
                 src="./img/icon_sub_tab_dp_highlighted@2x.png" />
        ...
        <ul class="rating-list">
          <li v-for="(comment,index) in iselectComments"
              :key="index"
              class="comment-item">
            <!--评论列表结构-->
            <div class="comment-header">
              <img :src="comment.user_pic_url"
...
<script>
import Bscrpoll from "better-scroll"
